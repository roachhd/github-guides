...
By incorporating certain keywords into the text of your Pull Request, you can associate issues with code. When your Pull Request is merged, the related issues are also closed. For example, entering the phrase `Closes #32` would close issue number 32 in the repository. For more information, check out our [help article][1].

[ ][2] [ ][3]

[1]: https://help.github.com/articles/closing-issues-via-commit-messages
[2]: https://guides.github.com# "Previous"
[3]: https://guides.github.com# "Next"
[Original Source](https://guides.github.com/introduction/flow/ "Permalink to Understanding the GitHub Flow · GitHub Guides")
